...
LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_1, answer.question_id, question.assessment_question, question.assessment_choice1 FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice1 AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice1 ) as choice1 ON count_takers.question_id = choice1.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_2, answer.question_id, question.assessment_question, question.assessment_choice2 FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice2 AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice2 ) as choice2 ON count_takers.question_id = choice2.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_3, answer.question_id, question.assessment_question, question.assessment_choice3 FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice3 AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice3 ) as choice3 ON count_takers.question_id = choice3.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.user_id) as total_choice_4, answer.question_id, question.assessment_question, question.assessment_choice4 FROM assessment_question_tbl question INNER JOIN answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN assessment_chosen assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice4 AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice4 ) as choice4 ON count_takers.question_id = choice4.question_id
...
$countSummaryAssessment->bind_param("iiiiiiiiiiiiiiiiiiiiiiiiiiiii", $assessment_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id);
...
$assessmentTakerQuery->bind_param('si', $assessment_id, $institution_id);
...
$overallScoreQuery->bind_param('si', $assessment_id, $institution_id);
...
$overallQuestionQuery->bind_param('si', $assessment_id, $institution_id);
...
if (empty($returnAssessmentTaker)) {
    ...
    $institutionAssessmentRate = number_format($averageInstitutionScore / $returnTotalScore['total_point']  * 100);
}
...
if ($returnSummaryAssessmentRow->num_rows != 0) { ?>
    ...
    <ul class="nav nav-pills nav-fill mt-4 pb-4">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="pill" href="#institution-statistics"><i class="fa-solid fa-chart-area"></i>Overall Post Assessment Overview</a>
        </li>
    </ul>
...
#F78080 ${progressValue * 3.6}deg,
  #443E3E ${progressValue * 3.6}deg
    ...
    <div class="tab-content">
        ...
        <?php
            $countRetakeSummaryAssessment = $mysqli->prepare("SELECT DISTINCT count_takers.question_id, IF(count_true.total_true IS NULL, 0, count_true.total_true) AS total_true, IF(count_false.total_false IS NULL, 0, count_false.total_false) AS total_false,  count_takers.status, IF(choice1.total_choice_1 IS NULL, 0, choice1.total_choice_1) AS total_choice_1,IF(choice2.total_choice_2 IS NULL, 0, choice2.total_choice_2) AS total_choice_2,IF(choice3.total_choice_3 IS NULL, 0, choice3.total_choice_3) AS total_choice_3, IF(choice4.total_choice_4 IS NULL, 0, choice4.total_choice_4) AS total_choice_4,IF(count_right.total_right IS NULL, 0, count_right.total_right) AS total_right,count_takers.total_taker,IF(count_wrong.total_wrong IS NULL, 0, count_wrong.total_wrong) AS total_wrong,count_takers.question_id,count_takers.assessment_question,count_takers.assessment_choice1,count_takers.assessment_choice2,count_takers.assessment_choice3,count_takers.assessment_choice4, count_takers.assessment_answer, count_takers.type,count_takers.question_answer FROM ( SELECT COUNT(*) as total_taker, answer.question_id,assessment_question,assessment_choice1,assessment_choice2,assessment_choice3,assessment_choice4,question_answer,assessment_answer,status,type FROM retake_chosen_tbl assessment INNER JOIN retake_answer_tbl answer ON assessment.code=answer.code INNER JOIN assessment_question_tbl question INNER JOIN assessment_tbl as lists ON lists.assessment_id =? INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE question.question_id = answer.question_id  AND assessment.assessment_id =?  AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ?  GROUP BY answer.question_id ) as count_takers

LEFT JOIN ( SELECT COUNT(*) as total_right, answer.question_id,assessment_question,question_answer,assessment_answer,answer.institution_id FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.question_id = answer.question_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id  WHERE BINARY assessment_answer.assessment_answer = BINARY answer.question_answer AND answer.institution_id = ? GROUP BY answer.question_id ) as count_right ON count_takers.question_id = count_right.question_id

LEFT JOIN (  SELECT COUNT(DISTINCT answer.code) as total_choice_1, answer.question_id, question.assessment_question, question.assessment_choice1 FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN retake_chosen_tbl assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice1 AND assessment.code = answer.code AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice1) as choice1 ON count_takers.question_id = choice1.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.code) as total_choice_2, answer.question_id, question.assessment_question, question.assessment_choice2 FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN retake_chosen_tbl assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice2 AND assessment.code = answer.code AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice2 ) as choice2 ON count_takers.question_id = choice2.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.code) as total_choice_3, answer.question_id, question.assessment_question, question.assessment_choice3 FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN retake_chosen_tbl assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice3 AND assessment.code = answer.code AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice3 ) as choice3 ON count_takers.question_id = choice3.question_id

 LEFT JOIN ( SELECT COUNT(DISTINCT answer.code) as total_choice_4, answer.question_id, question.assessment_question, question.assessment_choice4 FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.assessment_id = answer.assessment_id AND question.question_id = answer.question_id INNER JOIN retake_chosen_tbl assessment ON assessment.assessment_id = answer.assessment_id AND assessment.user_id = answer.user_id WHERE answer.question_answer = question.assessment_choice4 AND assessment.code = answer.code AND assessment.assessment_id = ? AND answer.assessment_id =? AND answer.institution_id = ? AND assessment.institution_id = ? GROUP BY answer.question_id, question.assessment_question, question.assessment_choice4) as choice4 ON count_takers.question_id = choice4.question_id
...
LEFT JOIN ( SELECT COUNT(*) as total_wrong, answer.question_id,assessment_question,question_answer,assessment_answer FROM assessment_question_tbl question INNER JOIN retake_answer_tbl answer ON question.question_id = answer.question_id INNER JOIN assessment_answer_tbl assessment_answer ON assessment_answer.question_id = question.question_id WHERE assessment_answer.assessment_answer != answer.question_answer AND answer.institution_id = ? GROUP BY answer.question_id ) as count_wrong ON count_takers.question_id = count_wrong.question_id");
            $countRetakeSummaryAssessment->bind_param("iiiiiiiiiiiiiiiiiiiiiiiiiiiii", $assessment_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $assessment_id, $assessment_id, $institution_id, $institution_id);
            $countRetakeSummaryAssessment->execute();
            $returnRetakeSummaryAssessmentRow = $countRetakeSummaryAssessment->get_result();


            //$countRetakeSummaryAssessmentRow = $countRetakeSummaryAssessment->get_result();


            $assessmentRetakeTakerQuery = $mysqli->prepare("SELECT * from retake_score_tbl WHERE assessment_id= ? AND institution_id = ?");
            $assessmentRetakeTakerQuery->bind_param('ss', $assessment_id, $institution_id);
            $assessmentRetakeTakerQuery->execute();
            $assessmentRetakeTakerQuery->store_result();
            $returnRetakeAssessmentTaker = $assessmentRetakeTakerQuery->num_rows;

            //COUNTS THE TOTAL OF SUM OF SCORES OF THE ASSESSMENT
            $totalRetakeScoreQuery = $mysqli->prepare("SELECT SUM(point) as total_point FROM assessment_question_tbl WHERE assessment_id = ?");
            $totalRetakeScoreQuery->bind_param('s', $assessment_id);
            $totalRetakeScoreQuery->execute();
            $totalRetakeresultRetakeScore = $totalRetakeScoreQuery->get_result();
            $returnRetakeTotalScore = $totalRetakeresultRetakeScore->fetch_assoc();
            //END
            ...
            //COUNTS THE TOTAL OF SUM OF SCORES OF THE ASSESSMENT TAKERS
            $overallRetakeScoreQuery = $mysqli->prepare("SELECT SUM(retake_score) as total_score FROM retake_score_tbl WHERE assessment_id = ? AND institution_id = ?");
            $overallRetakeScoreQuery->bind_param('ss', $assessment_id, $institution_id);
            $overallRetakeScoreQuery->execute();
            $resultRetakeScore = $overallRetakeScoreQuery->get_result();
            $returnRetakeOverallScore = $resultRetakeScore->fetch_assoc();
            //END
            ...
            //$overallQuestionQuery->bind_param('ss', $assessment_id,$institution_id);
            ...
            if (empty($returnRetakeAssessmentTaker)) {
                $averageInstitutionScore = $returnRetakeOverallScore['total_score'] / 1;
                $institutionAssessmentRate = number_format($returnRetakeOverallScore['total_score'] / 1 * 100);
            } else {
                $averageInstitutionScore = number_format($returnRetakeOverallScore['total_score'] / $returnRetakeAssessmentTaker);
                //$institutionAssessmentRate = number_format($returnRetakeOverallScore['total_score'] / $returnOverallQuestion['point']  * 100);
                $institutionAssessmentRate = number_format($averageInstitutionScore / $returnOverallQuestion['point']  * 100);
            }
            ...
            <?php
            if ($returnRetakeSummaryAssessmentRow->num_rows != 0) { ?>

                <div class="statistics-container d-flex justify-content-around mb-5">
                    <div class="statistics-item">
                        <h1><?php echo $returnRetakeAssessmentTaker ?></h1>
                        <h4>Assessment Takers</h4>
                    </div>
                    ...
                    <div class="statistics-item">
                        <h1><?php echo $returnRetakeTotalScore['total_point'] ?></h1>
                        <h4>Total Score</h4>
                    </div>
                ...
                <?php
                while ($returnRetakeChoiceRow = $returnRetakeSummaryAssessmentRow->fetch_assoc()) { ?>
                    <?php $ans = number_format($returnRetakeChoiceRow['total_right'] / $returnRetakeAssessmentTaker * 100);

                    ?>
                    <?php $pass = number_format($returnRetakeChoiceRow['total_right'] / $returnRetakeAssessmentTaker * 100); ?>
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ['Question1', 'Number1'],
                                <?php
                                if ($returnRetakeChoiceRow['type'] == 'Multiple Choice Question') {
                                    echo "['" . $returnRetakeChoiceRow["assessment_choice1"] . "', " . $returnRetakeChoiceRow["total_choice_1"] . "],", "['" . $returnRetakeChoiceRow["assessment_choice2"] . "', " . $returnRetakeChoiceRow["total_choice_2"] . "],", "['" . $returnRetakeChoiceRow["assessment_choice3"] . "', " . $returnRetakeChoiceRow["total_choice_3"] . "],", "['" . $returnRetakeChoiceRow["assessment_choice4"] . "', " . $returnRetakeChoiceRow["total_choice_4"] . "],";
                                } else if ($returnRetakeChoiceRow['type'] == 'Identification Question') {
                                    foreach ($identificationAnswer as $answer) {
                                        echo "['" . $answer['answer'] . "', " . $returnRetakeChoiceRow["total_right"] . "],";
                                    }
                                } else {
                                    foreach ($tfAnswer as $answer) {

                                        echo "['" . $answer['tfAnswer'] . "', " . $returnRetakeChoiceRow["total_right"] . "],";
                                    }
                                }
                                ?>
                            ...
                            var chart = new google.visualization.PieChart(document.getElementById('piechart_institution<?php echo $returnRetakeChoiceRow['question_id']; ?>'));
                            chart.draw(data, options);
                    ...
                    <div class="assessment-container mb-2">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <?php if ($returnRetakeChoiceRow['type'] == 'Multiple Choice Question') { ?>

                                    <h4><?php echo $returnRetakeChoiceRow['assessment_question']; ?></h4>
                                    <p><b><?php echo $ans ?>%</b> of the respondents ( <b><?php echo $returnRetakeChoiceRow['total_right']; ?> of <?php echo $returnRetakeAssessmentTaker ?> </b>) answered this question correctly.</p>
                                    <div class="choice-container"><span class="dot-indentifier choice1 mx-3"></span>
                                        <?php if ($returnRetakeChoiceRow['assessment_choice1'] != $returnRetakeChoiceRow['assessment_answer']) { ?>
                                            <span class="wrong-answer"> <?php echo $returnRetakeChoiceRow['assessment_choice1']; ?></span>
                                        <?php } else { ?>
                                            <span class="right-answer"><?php echo $returnRetakeChoiceRow['assessment_choice1']; ?></span>
                                        <?php } ?>
                                    </div>

                                    <div class="choice-container"><span class="dot-indentifier choice2 mx-3"></span>
                                        <?php if ($returnRetakeChoiceRow['assessment_choice2'] != $returnRetakeChoiceRow['assessment_answer']) { ?>
                                            <span class="wrong-answer"> <?php echo $returnRetakeChoiceRow['assessment_choice2']; ?></span>
                                        <?php } else { ?>
                                            <span class="right-answer"><?php echo $returnRetakeChoiceRow['assessment_choice2']; ?></span>
                                        <?php } ?>
                                    </div>

                                    <div class="choice-container"><span class="dot-indentifier choice3 mx-3"></span>
                                        <?php if ($returnRetakeChoiceRow['assessment_choice3'] != $returnRetakeChoiceRow['assessment_answer']) { ?>
                                            <span class="wrong-answer"> <?php echo $returnRetakeChoiceRow['assessment_choice3']; ?></span>
                                        <?php } else { ?>
                                            <span class="right-answer"><?php echo $returnRetakeChoiceRow['assessment_choice3']; ?></span>
                                        <?php } ?>
                                    </div>

                                    <div class="choice-container"><span class="dot-indentifier choice4 mx-3"></span>
                                        <?php if ($returnRetakeChoiceRow['assessment_choice4'] != $returnRetakeChoiceRow['assessment_answer']) { ?>
                                            <span class="wrong-answer"> <?php echo $returnRetakeChoiceRow['assessment_choice4']; ?></span>
                                        <?php } else { ?>
                                            <span class="right-answer"><?php echo $returnRetakeChoiceRow['assessment_choice4']; ?></span>
                                        <?php } ?>
                                    </div>
                                <?php } else if ($returnRetakeChoiceRow['type'] == 'Identification Question') { ?>
                                    <h4><?php echo $returnRetakeChoiceRow['assessment_question']; ?></h4>
                                    <p><b><?php echo $ans ?>%</b> of the respondents ( <b><?php echo $returnRetakeChoiceRow['total_right']; ?> of <?php echo $returnRetakeAssessmentTaker ?> </b>) answered this question correctly.</p>
                                    <?php
                                    $answers = array();
                                    ...
                                    $query = "SELECT *, answer.question_id, BINARY answer.assessment_answer, COUNT(assessment_answer) as total
                                        ...
                                        JOIN assessment_answer_tbl answer ON question.question_id = answer.question_id AND question.assessment_id = '$assessment_id'
                                        WHERE question.type = 'Identification Question'
                                        AND question.question_id = " . $returnRetakeChoiceRow['question_id'] . "
                                        GROUP BY answer.question_id,BINARY answer.assessment_answer";
                                    $result = mysqli_query($mysqli, $query);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        array_push($answers, $row['assessment_answer']);
                                ...
                                <?php } else { ?>
                                    ...
                                    <p><b><?php echo $ans ?>%</b> of the respondents ( <b><?php echo $returnRetakeChoiceRow['total_right']; ?> of <?php echo $returnRetakeAssessmentTaker ?> </b>) answered this question correctly.</p>
                                    <div class="choice-container"><span class="dot-indentifier choice1 mx-3"></span>
                                        <span class="right-answer"><?php echo $returnRetakeChoiceRow['assessment_answer']; ?></span>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="col-6">
                                <canvas id="piechart_questionss<?php echo $returnRetakeChoiceRow['question_id'] ?>" style="width:100%;max-width:600px"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        <?php
                        if ($returnRetakeChoiceRow['type'] == 'Multiple Choice Question') { ?>
                            var xValues = ["<?php echo $returnRetakeChoiceRow["assessment_choice1"] ?>", "<?php echo $returnRetakeChoiceRow["assessment_choice2"] ?>", "<?php echo $returnRetakeChoiceRow["assessment_choice3"] ?>", "<?php echo $returnRetakeChoiceRow["assessment_choice4"] ?>"];
                            var yValues = ["<?php echo $returnRetakeChoiceRow["total_choice_1"] ?>", "<?php echo $returnRetakeChoiceRow["total_choice_2"] ?>", "<?php echo $returnRetakeChoiceRow["total_choice_3"] ?>", "<?php echo $returnRetakeChoiceRow["total_choice_4"] ?>"];
                            var barColors = [
                                "#990099", "#109618", "#FF9900", "#DC3912"
                            ];

                            new Chart("piechart_questionss<?php echo $returnRetakeChoiceRow['question_id'] ?>", {
                                type: "pie",
                                data: {
                                    labels: xValues,
                                    datasets: [{
    ...
    GROUP BY answer.question_id, BINARY answer.question_answer ";
                            ...
                            ?>
                                ...
                                new Chart("piechart_questionss<?php echo $questionId ?>", {
                                    type: "pie",
                                    data: {
                                        labels: <?php echo $returnChartLabels ?>,
                                        datasets: [{
                        ...
                        <?php } else { ?>
                            var xValues = ["True", "False"];
                            var yValues = ["<?php echo $returnRetakeChoiceRow["total_true"] ?>", "<?php echo $returnRetakeChoiceRow["total_false"] ?>"];
                            var barColors = [
                                "#990099", "#109618", "#FF9900", "#DC3912"
                            ];
            ...
            <?php } else { ?>
                ...
                $(document).ready(function() {
                    ...
                    var progressBar = document.getElementById("post-institution-progress");
                    var valueContainer = document.getElementById("post-institution-value-container");
