...
LEFT JOIN ( SELECT COUNT(*) as total_true,answer.question_id FROM answer_tbl as answer WHERE question_answer = 'true' AND answer.institution_id = '$institution_id' ) as count_true ON count_takers.question_id = count_true.question_id

  LEFT JOIN ( SELECT COUNT(*) as total_false,answer.question_id FROM answer_tbl as answer WHERE question_answer = 'false' AND answer.institution_id = '$institution_id' ) as count_false ON count_takers.question_id = count_false.question_id
...
$assessmentTakerQuery = "SELECT * FROM assessment_score WHERE assessment_id = '$assessment_id' AND institution_id = '$institution_id'";
