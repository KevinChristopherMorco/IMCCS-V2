...
<div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="add-student-modal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            ...
            <form id="form-add-student" name="form1" class="form-add-student needs-validation" method="post" novalidate>
                    <div class="container">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="student-add-gender" class="col-2 col-form-label">Gender</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="student-add-gender" name="gender" placeholder="Enter Gender" required />
                        ...
                        <div class="row mb-3">
                            <label for="student-add-institution" class="col-2 col-form-label">Institution</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="student-add-grade-level" class="col-2 col-form-label">Grade Level</label>
                            <div class="col-10">
                                <div class="input-group has-validation">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-10">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" class="form-control myEmail" id="student-add-email" name="email" placeholder="Enter Email" required />
