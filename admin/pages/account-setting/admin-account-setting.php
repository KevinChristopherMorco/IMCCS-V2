...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link student-update" href="home-admin.php?page=admin-account-setting&subpage=admin-personal-info" data-id="<?php echo $_SESSION['user_id'] ?>">
        ...
        <li class="nav-item">
            <a class="nav-link student-update" href="home-admin.php?page=admin-account-setting&subpage=admin-change-password">
